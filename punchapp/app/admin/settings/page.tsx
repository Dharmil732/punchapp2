...
export default async function Page(){
  ...
  return <main className="card"><h1 className="text-lg font-semibold">Admin • System Settings</h1><p className='text-muted'>Company policies & payroll guardrails.</p></main>;
}

...
export default async function Page(){
  ...
  return <main className="card"><h1 className="text-lg font-semibold">Admin Dashboard</h1><div className='row'><div>Users</div><div>Policies</div><div>Audit</div></div></main>;
}
